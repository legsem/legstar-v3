...
public class CobolJaxbBeanGeneratorWriteTest extends CobolTestBase {
	...
	private File generateAndWrite(String source, CobolJaxbBeanGeneratorConfig config) throws IOException {
	...
	private CobolJaxbBeanGeneratorConfig getDefaultConfig() {
		return CobolJaxbBeanGeneratorTest.getDefaultConfig();
	}
