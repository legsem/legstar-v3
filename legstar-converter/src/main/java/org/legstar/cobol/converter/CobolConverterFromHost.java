 ...
 * <p>
 * The target java class must hold cobol annotations as produced by
 * legstar-generator.
 */
public class CobolConverterFromHost<T> {
	...
	public CobolConverterFromHost(CobolConverterConfigBase<?> config) {
		this(config, null);
	}

	public CobolConverterFromHost(CobolConverterConfigBase<?> config,
			CobolConverterFromHostChoiceStrategy<T> choiceStrategy) {
		this.stringConverter = new CobolConverterString(config.hostCharsetName(),
				config.truncateHostStringsTrailingSpaces());
		this.binaryNumberConverter = new CobolConverterBinaryNumber();
		this.zonedDecimalConverter = new CobolConverterZonedDecimal(config.hostMinusSign(),
				config.positiveSignNibbleValue(), config.negativeSignNibbleValue());
		this.packedDecimalConverter = new CobolConverterPackedDecimal(config.hostSpaceCharCode(),
				config.positiveSignNibbleValue(), config.negativeSignNibbleValue(),
				config.unspecifiedSignNibbleValue());
		this.floatConverter = new CobolConverterFloat();
		this.doubleConverter = new CobolConverterDouble();
