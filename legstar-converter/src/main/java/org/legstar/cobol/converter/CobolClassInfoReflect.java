...
public class CobolClassInfoReflect implements CobolClassInfo {
	...
	private CobolFieldInfo toFieldInfo(Field field) {
		...
		return new CobolFieldInfo(field.getName(), //
				...
				getMethod(field.getDeclaringClass(), setterName(field), field.getType()), //
				getCobolArray(field), //
				cobolItemType, //
				field.getType());
	}
	...
	/**
	 * No parameters method corresponding to method name.
	 * <p>
	...
	/**
	 * Single parameter method corresponding to method name.
	 * <p>
	 * The method name must exist in the parameter class.
	 * 
	 * @param clazz      the class implementing the requested method
	 * @param methodName the requested method name
	 * @param javaType   the single parameter type
	 * @return the method or throws a runtime exception if the method does not exist
	 *         or cannot be accessed
	 */
	private Method getMethod(Class<?> clazz, String methodName, Class<?> javaType) {
		try {
			return clazz.getMethod(methodName, javaType);
		} catch (ReflectiveOperationException e) {
			throw new RuntimeException(e);
		}
	}
	...
	/**
	 * Setter method name for the given field.
	 * <p>
	 * This assumes the bean was generated by legstar and therefore the setter name
	 * follows a strict set of rules.
	 * 
	 * @param f the field
	 * @return the setter method name for that field
	 */
