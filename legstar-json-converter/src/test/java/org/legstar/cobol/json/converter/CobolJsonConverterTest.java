...
public class CobolJsonConverterTest extends CobolTestBase {
	...
	public void testFlat01Unformatted() {
		check(convert("F0F0F1F0F4F3D5C1D4C5F0F0F0F0F4F3404040404040404040400215000F", Flat01Record.class, null, false));
	}
	...
	private <T> String convert(String payload, Class<T> beanClass, CobolChoiceStrategy<T> choiceStrategy) {
		return convert(payload, beanClass, choiceStrategy, true);
	}
