package legstar.samples.json.rdef02;
...
@JsonPropertyOrder ({"rdef02Key", "comDetail1Choice", "comItem3"})
public class Rdef02Record {
    ...
    @JsonPropertyOrder ({"rdef02Item1Choice", "comSelect"})
    ...
    public static class ComDetail1Choice {
        ...
        @JsonPropertyOrder ({"comAmount", "filler"})
