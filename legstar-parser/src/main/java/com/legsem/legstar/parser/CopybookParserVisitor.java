...
import com.legsem.legstar.copybook.CobolDataEntry.Range;
import com.legsem.legstar.copybook.CobolUsage;
import com.legsem.legstar.ccparser.Node.Visitor;
import com.legsem.legstar.ccparser.ast.ConditionValue;
import com.legsem.legstar.ccparser.ast.Copybook;
import com.legsem.legstar.ccparser.ast.DATA_NAME;
import com.legsem.legstar.ccparser.ast.DATE_PATTERN;
import com.legsem.legstar.ccparser.ast.DataEntryFormat1;
import com.legsem.legstar.ccparser.ast.DataEntryFormat3;
import com.legsem.legstar.ccparser.ast.DateFormatClause;
import com.legsem.legstar.ccparser.ast.FixedLengthOccurs;
import com.legsem.legstar.ccparser.ast.INTEGER;
import com.legsem.legstar.ccparser.ast.LEADING;
import com.legsem.legstar.ccparser.ast.LEVEL_77;
import com.legsem.legstar.ccparser.ast.LEVEL_88;
import com.legsem.legstar.ccparser.ast.LEVEL_NUMBER;
import com.legsem.legstar.ccparser.ast.Literal;
import com.legsem.legstar.ccparser.ast.LiteralRange;
import com.legsem.legstar.ccparser.ast.LowerBound;
import com.legsem.legstar.ccparser.ast.PictureString;
import com.legsem.legstar.ccparser.ast.RedefinesClause;
import com.legsem.legstar.ccparser.ast.SignClause;
import com.legsem.legstar.ccparser.ast.SignSeparate;
import com.legsem.legstar.ccparser.ast.UpperBound;
import com.legsem.legstar.ccparser.ast.UsageValue;
import com.legsem.legstar.ccparser.ast.ValueClause;
import com.legsem.legstar.ccparser.ast.VariableLengthOccurs;
...
public class CopybookParserVisitor extends Visitor {
	...
	public void visit(UsageValue node) {
		pendingEntries.peek().usage(CobolUsage.fromCobolString(node.toString()));
		recurse(node);
	}
