package com.legsem.legstar.ccparser;
...
import com.legsem.legstar.ccparser.CopybookCCLexer.LexicalState;
...
public class CopybookCCLexerTest {
	...
	@Test
	public void t10() {
		assertEquals("[NUMERIC_LITERAL:+0.6E08]", // 
				lex("+0.6E08", LexicalState.VALUE_STATE));
	}
