package legstar.samples.json.custdat;
...
@JsonPropertyOrder ({"customerId", "personalData", "transactions"})
public class CustomerData {
    ...
    @JsonPropertyOrder ({"customerName", "customerAddress", "customerPhone"})
    ...
    @JsonPropertyOrder ({"transactionNbr", "transaction"})
    public static class Transactions {
        ...
        @JsonPropertyOrder ({"transactionDateChoice", "transactionAmount", "transactionComment"})
        public static class Transaction {
            ...
            public static class TransactionDateChoice {
                ...
                @JsonPropertyOrder ({"transactionDay", "filler", "transactionMonth", "filler_3", "transactionYear"})
