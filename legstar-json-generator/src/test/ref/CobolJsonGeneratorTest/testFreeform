package legstar.samples.json.freeform;
...
@JsonPropertyOrder ({"recAHeader", "recAData"})
public class RecA {
    ...
    @JsonPropertyOrder ({"fld01", "fld02", "fld03", "fld04", "fld05", "fld06", "fld07", "fld08", "fld09RecType"})
